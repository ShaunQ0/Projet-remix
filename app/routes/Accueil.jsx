...
const Accueil = () => {
  return (
    <div className="accueil-container">
        ...
        <TabImg
          ...
          description={
            <ul>
              ...
              <li>
                <span className='span'>- de renseigner</span> les professeurs d’italien à tous niveaux sur la diffusion de l’enseignement de l’italien en région parisienne ;
              </li>
              <li>
      ...
      <img className="img" src={italieIcon} alt="Description de l'image" />
