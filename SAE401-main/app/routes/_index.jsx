...
import MeetingReports from "../components/Elements/MeetingReports";
import Forums from "../components/Elements/Forums";
  ...
  return (
    <>
      <div className="accueil-container">
        ...
        </div> {/* Fermeture de accueil-container2 */}
      ...
      </div> {/* Fermeture de accueil-container */}
    </>
  );
};
